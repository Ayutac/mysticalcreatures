...
public class MysticalCreatures
{
    ...
    // Create a Deferred Register to hold Blocks which will all be registered under the "mysticalcreatures" namespace
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(MODID);
    // Create a Deferred Register to hold Items which will all be registered under the "mysticalcreatures" namespace
