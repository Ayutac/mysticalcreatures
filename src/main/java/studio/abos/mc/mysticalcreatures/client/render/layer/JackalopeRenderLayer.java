...
@OnlyIn(Dist.CLIENT)
public class JackalopeRenderLayer extends RenderLayer<JackalopeRenderState, JackalopeModel> {
    private final JackalopeModel model;
    ...
    public JackalopeRenderLayer(JackalopeRenderer renderer, EntityModelSet entityModelSet) {
        super(renderer);
        ...
        this.model = new JackalopeModel(entityModelSet.bakeLayer(MysticalCreatures.JACKALOPE_LAYER));
    }

    @Override
    public void render(PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, JackalopeRenderState renderState, float yRot, float xRot) {
